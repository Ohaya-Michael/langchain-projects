...
def build_stores():
    ...
    #embeddings1 = HuggingFaceEmbeddings(model_name="sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2")

    real_estate = Chroma(
        collection_name="immobilien",  # use whatever collection name you actually used
    ...
    # cms_retriever = cms_store.as_retriever()
    # synthea_retriever = medical.as_retriever()
    return embeddings, real_estate, medical
